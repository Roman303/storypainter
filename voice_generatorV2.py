...
class SceneBasedAudiobookGenerator:
    ...
    def generate_audiobook_from_scenes(self):
        """Generiert Audio und erzeugt nur WAVs, die im Ordner noch fehlen."""
        from TTS.api import TTS
        import torch
        
        print("\n🎧 SZENEN-BASIERTER HÖRBUCH-GENERATOR (einfacher Modus)")
        print("="*60)
        ...
        for scene_idx, scene in enumerate(scenes, 1):
            ...
            for chunk_idx, chunk_text in enumerate(chunks, 1):
                ...
                # **HIER**: nur Dateiexistenz checken
                ...
                start = time.time()
                result = self.generate_chunk_audio(tts, chunk_text, scene_id, chunk_idx)
